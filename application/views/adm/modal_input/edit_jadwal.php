								...
								<div class="row">
										<div class="col-md-6">
												<div class="form-group">
														...
														<input id="kd_kar" type="text" class="form-control border-input" readonly placeholder="kd_jadwal" name="kd_karyawan" value="">
													<?php //} ?>
												</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
													...
													<select class="form-control" name="nama" id="nama_karyawan"  >
